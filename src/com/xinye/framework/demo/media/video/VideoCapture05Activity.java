 ...
 */
public class VideoCapture05Activity extends Activity implements OnClickListener, SurfaceHolder.Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button changeCameraBtn = (Button) findViewById(R.id.ChangeCamera);
        changeCameraBtn.setOnClickListener(new OnClickListener() {
            @Override
